...
const CardBox = props => (
    <View style={{ height: screenHeight * 0.40, borderColor: "#FFFFFF", borderWidth: 1, borderRadius: 10, marginVertical:20 }}>
        <View style={{ padding: 10 }}>
            <Text style={{ fontFamily: "Assistant-Bold", fontSize: 16, color: '#ffd200', alignSelf: "center", fontWeight: "bold" }}>{props.Type}</Text>
        </View>
        <View style={{ flex: 1, flexDirection: "row" }}>
            ...
            <View style={{ flex: 1 }}>
                ...
                <Text style={{ fontFamily: "Assistant-Bold", fontSize: 16, color: '#FFFFFF', alignSelf: "center" }}>{props.iosNumber}</Text>
                <Text style={{ fontFamily: "Assistant-Bold", fontSize: 16, color: '#FFFFFF', alignSelf: "center" }}>{props.iosAmount}</Text>
            </View>

            <View style={{ flex: 1 }}>
                <Text style={{ fontFamily: "Assistant-Bold", fontSize: 16, color: '#FFFFFF', alignSelf: "center" }}>Android</Text>
                <Text style={{ fontFamily: "Assistant-Bold", fontSize: 16, color: '#ffd200', alignSelf: "center", marginTop: -10 }} numberOfLines={1}>__</Text>
                <Text style={{ fontFamily: "Assistant-Bold", fontSize: 16, color: '#FFFFFF', alignSelf: "center" }}>{props.androidNumber}</Text>
                <Text style={{ fontFamily: "Assistant-Bold", fontSize: 16, color: '#FFFFFF', alignSelf: "center" }}>{props.androidAmount}</Text>
            </View>
            <View style={{ flex: 1 }}>
                <Text style={{ fontFamily: "Assistant-Bold", fontSize: 16, color: '#FFFFFF', alignSelf: "center" }}>Web</Text>
                <Text style={{ fontFamily: "Assistant-Bold", fontSize: 16, color: '#ffd200', alignSelf: "center", marginTop: -10 }} numberOfLines={1}>__</Text>
                <Text style={{ fontFamily: "Assistant-Bold", fontSize: 16, color: '#FFFFFF', alignSelf: "center" }}>{props.webNumber}</Text>
                <Text style={{ fontFamily: "Assistant-Bold", fontSize: 16, color: '#FFFFFF', alignSelf: "center" }}>{props.webAmount}</Text>
            </View>
        </View>
        <View style={{ padding: 10 }}>
        ...
        <View style={{ flex: 1, flexDirection: "row" }}>
            ...
            <View style={{ flex: 1, }}>
            <Text style={{ fontFamily: "Assistant-Bold", fontSize: 16, color: '#FFFFFF', alignSelf: "center", paddingHorizontal:20 }}>{props.Total}</Text>
                <Text style={{ fontFamily: "Assistant-Bold", fontSize: 16, color: '#FFFFFF', alignSelf: "center", paddingHorizontal:20 }}>Total</Text>
            </View>
            <View style={{ flex: 1 }}>
                <Text style={{ fontFamily: "Assistant-Bold", fontSize: 16, color: '#FFFFFF', alignSelf: "center",}}>{props.Amount}</Text>
